          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 20), // Tambahan jarak antar judul dan kartu
                _buildVoucherCard(
                  context,
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (_) => const FormExchangePage()),
                    );
                  },
                ),
              ],
    ...
    return GestureDetector(
      ...
      child: Card(
        ...
        child: ListTile(
          ...
          trailing: const Icon(Icons.arrow_forward_ios, color: Color(0xFF2D6B47)),
        ),
      ),
    );
  }
